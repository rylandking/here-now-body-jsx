    ...
    <Fragment>
      <div className="flex w-full border-b items-center justify-between">
        <div className="flex-shrink-0 hidden lg:flex">
          ...
          <div className="w-64">
            <input
              className="bg-gray-200 placeholder-gray-600 text-sm font-light focus:outline-none rounded-l-none rounded-r-lg py-3 pr-0 pl-3 block w-full appearance-none leading-normal"
              type="email"
